...
<html lang="en">
	...
	<body>
		...
		<?php echo 'Coloque o id do produto e as informações.'; ?>
		<?php if( isset($_POST) && $_POST ){?>
			<p>O produto foi editado com sucesso!</p>
		<?php }?>
...
<?php    
    ...
    if( isset($_POST) && $_POST ){
		...
		$selectQuery = "UPDATE produtos SET nome = '$nome', descricao = '$descricao', preco = '$preco' WHERE id_produto = '$id'";
